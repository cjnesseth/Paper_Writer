...
exceeds $\bar{p}_S$ in 2026/27, so the settlement is binding by \$4/MW-day at
...
floor explicitly as ``supporting near-term investment,'' a characterization
that reflects its role in preventing the price from collapsing in over-supplied
market conditions and protecting the revenue stream for marginal capacity.
