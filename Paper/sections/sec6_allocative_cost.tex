...
\citet{GlaeserLuttmer2003_rent} demonstrate that binding price controls
in misallocation-prone markets distort the allocation of goods toward
consumers with the strongest relationships to sellers, not toward consumers
with the highest willingness to pay. In capacity markets the analogue is
resource allocation: a binding cap suppresses the price signal that directs
capital toward the highest-value uses and redirects rents toward buyers
without ensuring that the capacity is valued most highly by those buyers.
The efficiency loss is not a simple deadweight triangle (which would arise
if supply were elastic to price) but a misallocation of a fixed stock of
capacity.

The settlement band (\$175--\$325) identifies a price interval that is
neither the competitive equilibrium ($c \approx \$150$, far below the
floor) nor the strategic equilibrium ($p^* \approx \$329$--\$333, above
the cap). It is an administratively imposed outcome. Whether this
intervention is welfare-improving depends on whether the strategic markup
--- of order \$4--\$8/MW-day above the cap --- is large enough to justify
the associated information loss and the investment distortion from
cap-binding. The SFE model suggests the markup is modest (1--3\% above
the cap) at the RTO level, supporting the view that the cap's revenue
transfer benefit is small relative to its informational cost. Section~\ref{sec:policy_alternatives}
